    ...
    return (
        <div className="card">
            ...
            <div className="grid p-fluid mt-3">
                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputNumber id="inputnumber" value={value8} onValueChange={(e) => setValue8(e ?? null)}></InputNumber>
                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputTextarea id="textarea" rows={3} value={value12} onChange={(e: any) => setValue12(e.target.value)}></InputTextarea>
