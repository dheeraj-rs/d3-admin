            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                    <Link href="/" className="flex align-items-center">
                        ...
                        />
                        <span className="text-900 font-medium text-2xl line-height-3 mr-8">D-Admin</span>
                    </Link>
                    ...
                    <div
                        className={classNames(
                            'menu-items align-items-center surface-0 flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2',
                            { hidden: isHidden }
                        )}
                        style={{ top: '100%' }}
                    >
                        ...
                        <div className="col-12 md:col-2" style={{ marginTop: '-1.5rem' }}>
                            ...
                            >
                                <img
                                    ...
                                    className="mr-2"
                                />
                                <span className="font-medium text-3xl text-900">D-Admin</span>
                            </Link>
                        </div>
